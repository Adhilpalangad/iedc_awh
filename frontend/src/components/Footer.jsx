        ...
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <div className="fsocs" style={{ display: 'flex', gap: '0.8rem', marginTop: '1rem' }}>
              ...
              <a href="https://wa.me/918606540566?text=Enquiry%20about%20IEDC%20AWH" className="fsoc" target="_blank" rel="noopener noreferrer" title="WhatsApp" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '32px', height: '32px', borderRadius: '50%', border: '1px solid var(--border)', color: 'var(--muted)', transition: 'color 0.2s, border-color 0.2s' }}>
